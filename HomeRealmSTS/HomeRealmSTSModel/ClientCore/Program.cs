...
namespace ClientCore
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // trustTokenParams.MessageSecurityVersion.SecurityVersion = "http://schemas.xmlsoap.org/soap/envelope/";

            //Console.WriteLine(trustTokenParams.MessageSecurityVersion.SecurityPolicyVersion.ToString());
            //Console.WriteLine(trustTokenParams.MessageSecurityVersion.SecurityVersion.ToString());
            ...
            Console.WriteLine(client.ClientCredentials.ClientCertificate.ToString());   
            Console.WriteLine(client.OpenAsync());
            Console.ReadLine();
